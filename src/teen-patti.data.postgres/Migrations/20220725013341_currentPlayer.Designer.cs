...
namespace teen_patti.data.postgres.Migrations
{
    ...
    [Migration("20220725013341_currentPlayer")]
            ...
            modelBuilder.Entity("teen_patti.common.Models.Persistence.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateDateUTC = new DateTime(2022, 7, 25, 1, 33, 40, 851, DateTimeKind.Utc).AddTicks(96),
                        ...
                        new
                        {
                            ...
                            CreateDateUTC = new DateTime(2022, 7, 25, 1, 33, 40, 851, DateTimeKind.Utc).AddTicks(99),
                            CurrencyAmount = 1200L,
